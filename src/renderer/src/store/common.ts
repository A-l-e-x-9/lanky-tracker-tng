...
export type SlamRange = IntRange<0, 4>
...
interface WinConActions {
  ...
  setWinCondition: (id: string | number, val: boolean | number) => void
}
...
export interface ShopState {
  ...
  shuffledAztecCranky: aztecCranky
  ...
  shuffledCastleFunky: castleFunky
  shuffledCastleCandy: castleCandy
  shuffledCastleSnide: castleSnide
}
...
interface ShopActions {
  ...
  setAztecCranky: (id: string, val: boolean) => void
  ...
  setGalleonCranky: (id: string, val: boolean) => void
  ...
  setCastleFunky: (id: string, val: boolean) => void
  setCastleCandy: (id: string, val: boolean) => void
  setCastleSnide: (id: string, val: boolean) => void
}
...
interface SlamActions {
  ...
  setCavesSlam: (id: string, val: boolean) => void
  setCastleSlam: (id: string, val: boolean) => void
}
