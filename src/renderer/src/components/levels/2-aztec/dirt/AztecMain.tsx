...
import { useGeneralDirt, useOasisKasplat, useAztecBack, useLlamaOutsideCrate } from '@renderer/hooks/aztec'
import { useShockwave, useRocket, useClimbing, useVine } from '@renderer/hooks/kongs'
