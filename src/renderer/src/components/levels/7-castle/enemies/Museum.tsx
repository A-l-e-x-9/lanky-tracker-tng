  ...
  return (
    <DropPool>
      <CastleCheck
        ...
        canGetLogic={inStage.in && chunky && canSlam && kosha}
        canGetBreak={inStage.out && chunky && canSlam && kosha}
      />
      <CastleCheck
        id={7362}
        name="Museum Enemy 0"
        region="Various Castle Rooms"
        canGetLogic={inStage.in && chunky && canSlam}
        canGetBreak={inStage.out && chunky && canSlam}
      />
      <CastleCheck
        id={7363}
        name="Museum Enemy 1"
