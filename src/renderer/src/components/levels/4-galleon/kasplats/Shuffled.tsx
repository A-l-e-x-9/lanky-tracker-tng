...
import { useGeneralThing, useDiddyGoldGb, useKevin, useCannonKasplat, useChunkySeasickGb, useGalleonLighthouseInside, useDiddyMechGb, useLankyGoldGb } from '@renderer/hooks/galleon'
