        ...
        <h2>DK Portal Shuffler</h2>
          <section className="pool">
            ...
            <SimpleRadioIcon
                ...
                updateItem={setJapesPortal}
            />
            <p>Outside Lanky's painting room</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            <SimpleRadioIcon
                ...
                updateItem={setAztecPortal}
            />
            <p>In the Tiny Temple pool, Tiny's prison room, or Lanky's Necky room</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            <SimpleRadioIcon
                ...
                updateItem={setAztecPortal}
            />
            <p>In the first dead end of DK's 5-Door Temple room</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            <SimpleRadioIcon
                ...
                updateItem={setFactoryPortal}
            />
            <p>At or around the Prod Room's Troff 'n' Scoff portal</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            <SimpleRadioIcon
                ...
                updateItem={setFactoryPortal}
            />
            <p>At Lanky's switch to free Chunky</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            <SimpleRadioIcon
                ...
                updateItem={setGalleonPortal}
            />
            <p>Inside the Lighthouse, one level up</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            <SimpleRadioIcon
                ...
                updateItem={setForestPortal}
            />
            <p>In either of Lanky's mushroom top rooms</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            />
            <p>Where a certain refrigerator once led...</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
            ...
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
                title="The DK Portal is in the big tree."
                storeKey="treePortal"
                prefix="shuffledCastlePortals"
                updateItem={setCastlePortal}
            />
            <p>In Chunky's room in the tree</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
                ...
                updateItem={setCastlePortal}
            />
            <p>Bottom floor/Crypt entrance</p>
            <SimpleRadioIcon
                imgUrl={dkPortalIcon}
